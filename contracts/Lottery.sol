...
contract Lottery {
    ...
    uint256 public immutable rebateEpochDuration;
    uint256 public immutable bpsRebate;
    // Event
    ...
    function closeEpochAndStartRNG() external payable {
        ...
        _rng[currentLotteryEpoch] =
            uint256(keccak256(abi.encodePacked(block.timestamp, block.number, block.prevrandao)));
    }
